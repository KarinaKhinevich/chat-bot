...
from chat_bot.services.openai_service.rag_agent.rag_agent import RAGAgent
...
class ChatService:
    ...
    async def ask_question(self, question: str, k: int = 5) -> Tuple[str, List[str]]:
        ...
        try:
            ...
            answer = result.get("answer", "I'm sorry, I couldn't generate an answer to your question.")
            ...
            logger.info(f"RAG pipeline completed: moderated={moderated}, relevant={is_relevant}, score={relevance_score}")
