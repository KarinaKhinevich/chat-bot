...
from chat_bot.config import ChunkingSettings, OpenAISettings
    ...
    def _semantic_split(
        ...
        try:
            ...
            text_splitter = SemanticChunker(
                self._embeddings, breakpoint_threshold_type=breakpoint_threshold_type
            )
    ...
    def _general_split(
        ...
        try:
            ...
            for i, current_chunk in enumerate(base_chunks):
                ...
                enhanced_metadata = {**metadata, "chunk_index": i}

                # Create document with enhanced content and metadata
                contextualized_chunks.append(
                    Document(
                        page_content=full_chunk_content, metadata=enhanced_metadata
                    )
                )
